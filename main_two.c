...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/02 14:59:24 by ayafdel           #+#    #+#             */
/*   Updated: 2021/02/02 15:00:58 by ayafdel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_player(void)
{
	...
	tmp_x = g_player.x + cos(g_player.rotation_angle + g_a) *
	g_player.move_step;
	tmp_y = g_player.y + sin(g_player.rotation_angle + g_a) *
	g_player.move_step;
	g_a = 0;
...
void	draw_player(void)
{
	...
	while (i != g_tile_size)
	{
		...
		my_mlx_pixel_put(&g_mlx, g_player.line_x * MINIMAP_SCALE,
		g_player.line_y * MINIMAP_SCALE, GREEN);
		i++;
	}
}
