...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/02 15:07:58 by ayafdel           #+#    #+#             */
/*   Updated: 2021/02/02 15:07:59 by ayafdel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fetch_s(char *str)
{
	...
	while (str[i] == ' ' && str[i] != '\0')
		i++;
	tmp = mlx_xpm_file_to_image(g_mlx.ptr, str + i,
...
void	fetch_we(char *str)
{
	...
	while (str[i] == ' ' && str[i] != '\0')
		i++;
	tmp = mlx_xpm_file_to_image(g_mlx.ptr, str + i,
	&g_texture.west_texture_w, &g_texture.west_texture_h);
	if (tmp == NULL)
