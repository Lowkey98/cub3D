...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/02/02 15:53:48 by ayafdel           #+#    #+#             */
/*   Updated: 2021/02/02 16:06:51 by ayafdel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				draw_player();
void				rotate_player();
float				distance_two_points(float x_one, float y_one,
float x_two, float y_two);
...
void				render_walls();
void				draw_line(float x_one, float y_one, float x_zero,
float y_zero);
void				draw_player();
